...
# Configure Wine for UTF-8
mkdir -p $WINEPREFIX
wine reg add "HKEY_LOCAL_MACHINE\System\CurrentControlSet\Control\Nls\CodePage" /v ACP /t REG_SZ /d 65001 /f
wine reg add "HKEY_LOCAL_MACHINE\System\CurrentControlSet\Control\Nls\CodePage" /v OEMCP /t REG_SZ /d 65001 /f
